...
fun LoginScreen(navController: NavHostController) {
    ...
    Column(modifier = Modifier
        ...
        }, label = { Text(text = "Student ID") }, keyboardOptions = KeyboardOptions.Default.copy(imeAction = ImeAction.Next),
            leadingIcon = {
                Icon(
        ...
        }, label = { Text(text = "Password") }, keyboardOptions = KeyboardOptions.Default.copy(imeAction = ImeAction.Done, keyboardType = KeyboardType.Password),
